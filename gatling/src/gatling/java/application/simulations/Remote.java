...
public class Remote extends SimulationBase {
	{
		...
		HttpRequestActionBuilder requestBuilder = http("remote_call")
				.get("/remote");
		...
		setUp(httpProtocolBuilder, requestBuilder, "Receive from remote call");
	}
}
